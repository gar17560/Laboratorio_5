...
# 416 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
static double
...
# 609 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
  ...
  if(*f == '.') {
   flag |= 0x4000;
   f++;
# 639 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
   {
    prec = 0;
    while(isdigit((unsigned)*f))
     prec = prec*10 + *f++ - '0';
  ...
  case 0:
   goto alldone;
# 681 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
  case 'f':
   flag |= 0x400;
   break;
...
# 1131 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
     if(prec <= 12)
    ...
    if(flag & 0x03)
     width--;
# 1194 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
    {
...
# 1309 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
  if(prec == 0 && val == 0)
   prec++;
# 1358 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
  if(c < prec)
   c = prec;
  else if(prec < c)
   prec = c;
...
# 1400 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
  if(width > c)
   ...
   width = 0;
# 1441 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
  {
...
# 1552 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.05\\pic\\sources\\c90\\common\\doprnt.c"
 }
